...
import { FourPartComponent } from '../home/components/four-part/four-part.component';
...
@NgModule({
  declarations: [
   ...
   // RatingComponent,
    ...
    FilterDialogComponent , MainInfoComponent , ProductFilterComponent, QuickViewComponent
  ],
  imports: [
    CommonModule,
